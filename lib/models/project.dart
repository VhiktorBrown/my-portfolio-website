...
List<Project> demoProjects = [
  Project(
      ...
      link: "https://play.google.com/store/apps/details?id=com.app.iquest_unizik",
  ...
  Project(
      ...
      link: "https://play.google.com/store/apps/details?id=com.app.syticks",
      iconPath: "assets/icons/google_play.svg",
  ),
  Project(
      ...
      link: "https://play.google.com/store/apps/details?id=com.app.syticks_organizers",
    iconPath: "assets/icons/google_play.svg",
  ),
  Project(
      ...
      description: "Fintech app responsible for tracking your finances and helping you categorize them into different sections and displaying them "
          "in a pie chart",
    link: "https://github.com/VhiktorBrown/track-your-finance",
    iconPath: "",
  ),
  Project(
      title: "Order Food",
      description: "A food ordering app that helps users you find their favourite dishes.",
    link: "https://github.com/VhiktorBrown/OrderFood",
    iconPath: "",
  ),
  Project(
    ...
    link: "https://github.com/VhiktorBrown/Paystack-webview-android",
    iconPath: "",
  )
];